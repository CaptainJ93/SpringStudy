...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/deliveryquality/reportbycity/listtimeareaproportiontotal">每月-大区封发汇总</a></li>
	</ul>
	<shiro:hasPermission name="delivery:deliveryOrderintransit:view">
	<form:form id="searchForm" modelAttribute="deliveryQualityReportTimeAreaProportion" action="${ctx}/deliveryquality/reportbycity/listtimeareaproportiontotal" method="post" class="breadcrumb form-search">
