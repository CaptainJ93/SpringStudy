...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/deliveryquality/reportbycity/listproportiontotal1">每月-城市封发汇总</a></li>
	</ul>
	<shiro:hasPermission name="delivery:deliveryOrderintransit:view">
	<form:form id="searchForm" modelAttribute="deliveryQualityReportCityProportion" action="${ctx}/deliveryquality/reportbycity/listproportiontotal1" method="post" class="breadcrumb form-search">
