 ...
 */
package com.best1.scm.modules.act.service.ext;
...
import com.best1.scm.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.best1.scm.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.best1.scm.modules.sys.entity.User(null, userId)))){
