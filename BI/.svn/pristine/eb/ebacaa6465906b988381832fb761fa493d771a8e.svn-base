...
<script src="js/pgMorderStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="pgMorderStatForm" method="post">
		<%
			String menuName = "";
		...
		<div class="list searchList">
			<ul class="listShow">
				<li>
			   		<label>节目时间:</label>
			   		<input id="prmStartTime" name="prmStartTime" class="easyui-datetimebox" style="width: 100px"/>-<input  id="prmEndTime" name="prmEndTime" class="easyui-datetimebox" style="width: 100px"/><span style="color: red;">*</span>
			   </li>
				<!-- 会员信息 -->
			   <li>
			   		<label>会员等级:</label>
		...
		<table id="pgMorderStatTable"></table>
	</div>
</body>
</html>