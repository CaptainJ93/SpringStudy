...
<script src="js/complaintStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="complaintStatForm" method="post">
		<%
			String menuName = "";
		...
		<div class="list searchList">
			<ul class="listShow">
			   ...
			   <li>
			   		<label>客诉建立日期:</label>
			   		<input id="complaintedStartDate" name="complaintedStartDate" class="easyui-datetimebox" style="width: 100px"/>-<input  id="complaintedEndDate" name="complaintedEndDate" class="easyui-datetimebox" style="width: 100px"/>
			   </li>
			   <li>
			   		<label>客诉结案日期:</label>
			   		<input id="closedStartDate" name="closedStartDate" class="easyui-datetimebox" style="width: 100px"/>-<input  id="closedEndDate" name="closedEndDate" class="easyui-datetimebox" style="width: 100px"/>
			   </li>
			</ul>
			<ul class="listBtn">
		...
		<table id="complaintStatTable"></table>
	</div>
</body>
</html>