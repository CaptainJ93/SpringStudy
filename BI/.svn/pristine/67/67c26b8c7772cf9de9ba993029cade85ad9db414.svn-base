...
<script src="js/sourceChannelCustStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="sourceChannelCustStatForm" method="post">
		<%
			String menuName = "";
		...
		<table id="sourceChannelCustStatTable"></table>
	</div>
</body>
</html>