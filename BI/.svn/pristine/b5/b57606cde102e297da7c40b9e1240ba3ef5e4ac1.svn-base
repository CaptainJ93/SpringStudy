...
import com.best1.report.db.FinanceDao;
...
public class FinanceServiceImpl extends BaseServiceImpl implements FinanceService{
	...
	public DataModel getsaleDetailsByPage(HashMap paramMap) throws Exception {
		try {
			DataModel resData = financeDao.getSaleDetailsByPage(paramMap);
