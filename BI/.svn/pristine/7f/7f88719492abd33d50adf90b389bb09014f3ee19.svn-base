...
<script src="js/memberLevelCustStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="memberLevelCustStatForm" method="post">
		<%
			String menuName = "";
		...
		<!-- <table id="memberLevelCustStatTable"></table> -->
		<div style="width:100%"> 
			<div class="leftDiv"> 
				<table id="memberLevelCustStatTable"></table>
			</div> 
