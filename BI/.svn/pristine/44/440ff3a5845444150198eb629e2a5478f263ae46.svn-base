	...
	$.getCaches("../cache!getCache.action","",function(cacheKeys){
		var options={
				...
				colModel:[
					...
					{name:"liveid",label:"节目号",width:"100",fixed:true},
					{name:"cueid",label:"cue号",width:"100",fixed:true},
					...
					{name:"supplierid",label:"厂商代码",width:"100",fixed:true},
					...
					{name:"pd3",label:"pd3",width:"100",fixed:true},
					{name:"pd4",label:"pd4",width:"100",fixed:true},
					{name:"sh1",label:"sh1",width:"100",fixed:true},
					{name:"sh2",label:"sh2",width:"100",fixed:true},
					{name:"sh3",label:"sh3",width:"100",fixed:true},
					{name:"sh4",label:"sh4",width:"100",fixed:true},
					{name:"day",label:"星期",width:"100",fixed:true},
					{name:"ordercc",label:"订单数",width:"70",fixed:true},
					{name:"validordercc",label:"有效订单号个数",width:"100",fixed:true},
					{name:"validorderquantity",label:"有效订单件数",width:"100",fixed:true},
					{name:"validproductamount",label:"有效金额",width:"70",fixed:true},
					{name:"validmaoli",label:"有效毛利",width:"70",fixed:true},
					{name:"returnordercc",label:"销退订单数",width:"80",fixed:true},
					{name:"returnorderamount",label:"销退金额",width:"70",fixed:true},
					{name:"changeordercount",label:"换货订单数",width:"80",fixed:true},
					{name:"changeamount",label:"换货金额",width:"70",fixed:true},
					...
					{name:"complaintcount",label:"客诉个数",width:"70",fixed:true},
					{name:"subchannelid",label:"通路号",width:"70",fixed:true},
					{name:"prdqstarttime",label:"节目开始时间（具体到时分秒）",width:"200",fixed:true},
					{name:"prdqendtime",label:"节目结束日期（具体到时分秒）",width:"200",fixed:true},
					{name:"prdqstarttimestarthour",label:"节目开始时间(具体几点）",width:"150",fixed:true},
					{name:"prdqstarttimeendhour",label:"节目结束时间(具体几点）",width:"150",fixed:true}
				],
				multiselect:false,
				loadonce: false,
				caption:"节目业绩查询列表",
		...
		var options2={
				...
				colModel:[
					...
					{name:"validorderquantity",label:"有效订单商品数",width:"100",fixed:true},
					{name:"validproductamount",label:"有效订单销售额",width:"100",fixed:true},
					{name:"validmaoli",label:"有效毛利",width:"100",fixed:true},
					{name:"newcustordcount1d",label:"当天注册当天购买会员数",width:"150",fixed:true},
					{name:"newcustordcount30d",label:"30天内有多次购买会员数",width:"150",fixed:true},
					{name:"newcustordcount90d",label:"90天内有多次购买会员数",width:"150",fixed:true},
					{name:"newcustordcount1y",label:"1年内有多次购买会员数",width:"150",fixed:true},
