...
<script src="js/areaChannelStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="areaChannelStatForm" method="post">
		<%
			String menuName = "";
		...
		<div class="list searchList">
			...
			<div id="areaZipCodeContent" class="menuContent" style="display:none; position: absolute;z-index: 999">
				<ul id="areaZipCodeTree" class="ztree" style="margin-top:0; width:180px;height: 200px;"></ul>
			</div>
		</div>
		</form>
		<table id="areaChannelStatTable"></table>
	</div>
</body>
</html>