...
public class ProductStatAction extends BaseAction {
	...
	public String spOrderStatList() throws Exception {
		DataModel resData = productStatService.getSpOrderStatByPage(paramMap);
		//判断是否是excel导出
	...
	public String classOrderStatList() throws Exception {
		DataModel resData = productStatService.getClassOrderStatByPage(paramMap);
		//判断是否是excel导出
		if(paramMap.get("export")!=null &&"excel".equals(paramMap.get("export"))){
			dealGarbled();//处理paramMap的乱码问题
			commonOutExcel(resData);
	...
	public String productOrderStatList() throws Exception {
		DataModel resData = productStatService.getProductOrderStatByPage(paramMap);
		//判断是否是excel导出
		if(paramMap.get("export")!=null &&"excel".equals(paramMap.get("export"))){
			dealGarbled();//处理paramMap的乱码问题
			commonOutExcel(resData);
	...
	public String prodReturnStatList() throws Exception {
		DataModel resData = productStatService.getProdReturnStatByPage(paramMap);
		//判断是否是excel导出
		if(paramMap.get("export")!=null &&"excel".equals(paramMap.get("export"))){
			dealGarbled();//处理paramMap的乱码问题
			commonOutExcel(resData);
	...
	public String prodCompaintStatList() throws Exception {
		DataModel resData = productStatService.getProdCompaintStatByPage(paramMap);
		//判断是否是excel导出
		if(paramMap.get("export")!=null &&"excel".equals(paramMap.get("export"))){
			dealGarbled();//处理paramMap的乱码问题
			commonOutExcel(resData);
	...
	public String productTodayList() throws Exception {
		DataModel resData = productStatService.getProductTodayByPage(paramMap);
		//判断是否是excel导出
		if(paramMap.get("export")!=null &&"excel".equals(paramMap.get("export"))){
			dealGarbled();//处理paramMap的乱码问题
			commonOutExcel(resData);
