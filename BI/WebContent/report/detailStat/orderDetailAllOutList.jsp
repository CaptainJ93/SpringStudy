...
<script src="js/orderDetailAllOutList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="orderDetailAllOutForm" method="post">
		<%
			String menuName = "";
		...
		<table id="orderDetailAllOutTable"></table>
	</div>
</body>
</html>