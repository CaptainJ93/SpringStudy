...
<script src="js/createbyComplaintStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="createbyComplaintStatForm" method="post">
		<%
			String menuName = "";
		...
		<table id="createbyComplaintStatTable"></table>
	</div>
</body>
</html>