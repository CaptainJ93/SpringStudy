...
<script src="js/prodCompaintStat2List.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="prodCompaintStat2Form" method="post">
		<%
			String menuName = "";
		...
		<table id="prodCompaintStat2Table"></table>
	</div>
</body>
</html>