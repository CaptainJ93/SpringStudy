...
<script src="js/spComplaintStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="spComplaintStatForm" method="post">
		<%
			String menuName = "";
		...
		<div class="list searchList">
			<ul class="listShow">
			   ...
			   <li>
			   		<label>厂商代码:</label>
			   		<input type="text" id="supplierid" onkeyup="this.value=this.value.replace(/[^\d!,]/g,'')"/>&nbsp;<span>","分割</span>
			   </li>
		...
		<table id="spComplaintStatTable"></table>
	</div>
</body>
</html>