...
<script src="js/areaStatList.js" type="text/javascript"></script>
<style>
...
<body style="overflow-x: hidden;">
	<div class="mainSilde mainBlock">
		...
		<form action="" id="areaStatForm" method="post">
		<%
			String menuName = "";
		...
		<div class="list searchList">
			<ul class="listShow">
			   ...
			   <li>
			   		<label>地区:</label>
			   		<input type="text" id="areaZipCodeName" readonly="readonly" onclick="showAreaZipCode();"/>&nbsp;<a id="clearAreaZipCode" href="#">清空</a>
					<input type="hidden" id="areaZipCodeId"/>
			   </li>
			   <li>
			   		<label>统计维度:</label>
			   		<input type="hidden" id="checkDimension" value="10"/>
			   		<input type="radio" name="dimension" value="10" id="dimensionProvince" checked="checked"/>省&nbsp;
			   		<input type="radio" name="dimension" value="11" id="dimensionCity"/>市&nbsp;
			   		<input type="radio" name="dimension" value="12" id="dimensionArea"/>区&nbsp;<span style="color: red;">*</span>
			   </li>
			</ul>
			<ul class="listBtn">
			...
			<div id="areaZipCodeContent" class="menuContent" style="display:none; position: absolute;z-index: 999">
				<ul id="areaZipCodeTree" class="ztree" style="margin-top:0; width:220px;height: 200px;"></ul>
			</div>
