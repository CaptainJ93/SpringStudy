function Jatoolsbar(cfg) {
    ...
    this.exportAs = function (as) {
        window.location = encodeURI(encodeURI("jatoolsreport?_action_type=export&do_export=1&_exp_file_name="+document.getElementById("filename").value+"&_job_session_id=" + $('#jsettings', this.ct).attr('jobSessionId') + "&as=" + as));
    };   
