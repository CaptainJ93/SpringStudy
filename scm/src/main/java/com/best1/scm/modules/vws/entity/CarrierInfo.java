...
public class CarrierInfo extends DataEntity<CarrierInfo> {
	...
	private int issupplierused ; // supplier can use or not
	...
	public int getIssupplierused() {
		return issupplierused;
	}

	public void setIssupplierused(int issupplierused) {
		this.issupplierused = issupplierused;
	}
