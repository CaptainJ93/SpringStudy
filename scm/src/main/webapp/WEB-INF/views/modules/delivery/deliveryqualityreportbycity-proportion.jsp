...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/deliveryquality/reportbycity/listproportion">每月-城市封发占比</a></li>
	</ul>
	<shiro:hasPermission name="delivery:deliveryOrderintransit:view">
	<form:form id="searchForm" modelAttribute="deliveryQualityReportCityProportion" action="${ctx}/deliveryquality/reportbycity/listproportion" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="deliveryQualityReportCityProportion">
			<tr>
			<td><fmt:formatDate value="${deliveryQualityReportCityProportion.everyday}" pattern="yyyy-MM-dd"/></td>
