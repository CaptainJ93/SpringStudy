...
<body>
	...
	<form:form id="inputForm" modelAttribute="scmSupplierSroheader" action="${ctx}/supplier/scmSupplierSroheader/forcedClosure" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
&nbsp;&nbsp;&nbsp;&nbsp;<span >配送公司：<b>${carrierInfo}</b></span>
&nbsp;&nbsp;&nbsp;&nbsp;<span >收回使用的快递单号：<b>${scmSupplierSroheader.receiptdeliveryorderid}</b></span>
		</div>
		</div>
		
	<div>
			<shiro:hasPermission name="supplier:scmSupplierSroheader:editForAdministrator">
			<input id="btnSubmit" class="btn btn-primary" type="submit" value="强迫结案"/>&nbsp;		
			</shiro:hasPermission>	
	</div>	
