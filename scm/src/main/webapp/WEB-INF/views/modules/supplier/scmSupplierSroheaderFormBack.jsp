...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="supplier:scmSupplierSroheaderSaveAllowed:view"><li><a href="${ctx}/supplier/scmSupplierSroheader/listSaveAllowed">退货单头信息列表</a></li></shiro:hasPermission>
