...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="supplier:scmSupplierSroheaderSaveAllowed:view"><li><a href="${ctx}/supplier/scmSupplierSroheader/">退货单头信息列表</a></li></shiro:hasPermission>
	...
	<form:form id="inputForm" modelAttribute="scmSupplierSroheader" action="${ctx}/supplier/scmSupplierSroheader/save" method="post" class="form-horizontal">
		...
		<div class="control-group" style="color:#F00">
			<b>${tips}</b>
		</div>	
