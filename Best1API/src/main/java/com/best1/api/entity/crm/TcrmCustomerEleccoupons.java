...
@Entity
public class TcrmCustomerEleccoupons extends BaseObject {

	private Long coupongroupnumber;
	private Long fromid;
	private Long electronicno;
	...
	public Long getElectronicno() {
		return electronicno;
	}
	public void setElectronicno(Long electronicno) {
