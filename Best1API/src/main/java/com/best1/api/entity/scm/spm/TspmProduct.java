...
/**
 * This field corresponds to the database table TSPM_PRODUCT
 * 
 */
@Entity
@Table(name = "Tspm_Product")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TspmProduct extends BaseObject {
	...
	private Integer salestype;// Added by fanxuankai 2014-09-17接单方式
	private Integer commisiontype;
	private Double commissionrate;
	private Integer lclasscode;
	private Integer mclasscode;
	private Integer sclasscode;
	private Integer potype;// Added by fanxuankai 2014-09-17 采购单类别
	private Long purchaseid;
	private Long mdid;
	private Long companyid;

	/***
	 * private List<TspmProductcolourstyle> prdctolourstyles; private
	 * List<TspmProductgeneral> prdgenerals; private List<TscmProductimage>
	 * prdimages;
	 ***/
	/** 错误代码 **/
