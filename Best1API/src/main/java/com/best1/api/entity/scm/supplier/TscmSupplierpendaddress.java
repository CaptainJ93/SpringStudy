...
public class TscmSupplierpendaddress extends TscmSupplierpendaddressKey {
    ...
    private String contactpersoname;
	...
	public String getContactpersoname() {
		return contactpersoname;
	}


	public void setContactpersoname(String contactpersoname) {
		this.contactpersoname = contactpersoname;
	}
