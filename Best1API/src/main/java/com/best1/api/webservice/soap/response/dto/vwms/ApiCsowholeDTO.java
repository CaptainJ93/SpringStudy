...
public class ApiCsowholeDTO {
	    ...
	    private String giftpackmessage;
	    ...
	    private Integer productcolourclass;

	  
	    private Integer productcolourcode;

	   
	    private String productcolourdescription;

	   
	    private Integer productstyleclass;

	   
	    private Integer productstylecode;

	   
	    private String productstyledescription;
	    ...
	    private Integer promotionrelationseq;
		...
		public Long getInvoicezipcode() {
			return invoicezipcode;
		}


		public void setInvoicezipcode(Long invoicezipcode) {
