...
public class CustomerServer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		//factory.setAddress("http://127.0.0.1:8080/Best1API/webservice/com.best1.api.webservice.soap.view.SupplierViewSoapService");
		CustomerSoapService customerOrderService = (CustomerSoapService) factory.create();
		//Long customerId = Long.valueOf(request.getParameter("customerid"));
		Long customerId=20011L;
		CustomerResult queryCustomer = customerOrderService.queryCustomer(customerId);
		System.out.println(queryCustomer);
		response.getWriter().println(queryCustomer);
...
//		Long productid=null;
//		customerOrderService.querylotterybonuValidcountFromCustomerid(customerid);
